...
const btnStyle = cva(
  'inline-flex items-center justify-center no-underline truncate disabled:opacity-60 disabled:cursor-default text-white transition-colors duration-200 ease-in-out rounded-lg',
  {
    variants: {
      variant: {
        default:
          'bg-primary-B-500 border border-primary-B-500 [&:not(:disabled)]:hover:border-primary-B-500/80  [&:not(:disabled)]:hover:bg-primary-B-500/70 [&:not(:disabled)]:active:border-primary-B-600 [&:not(:disabled)]:active:bg-primary-B-600',
        outline:
          'bg-transparent border border-primary-B-200 [&:not(:disabled)]:hover:border-primary-B-300 [&:not(:disabled)]:hover:bg-primary-B-200/5 [&:not(:disabled)]:active:bg-primary-B-200/10 text-primary-B-200 data-[state=current]:bg-primary-B-200',
        'outline-light':
